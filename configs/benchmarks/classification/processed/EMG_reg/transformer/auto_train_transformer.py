...
def main():
    ...
    # base_path = "configs/classification/processed/EMG/transformer/tiny/tiny_p4_bs128.py"
    # base_path = "configs/classification/processed/EMG/transformer/tiny/tiny_p6_bs128.py"
    # base_path = "configs/classification/processed/EMG/transformer/tiny/tiny_p8_bs128.py"
    base_path = "configs/classification/processed/EMG/transformer/tiny/tiny_p12_bs128.py"
