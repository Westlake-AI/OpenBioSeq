...
train_pipeline_1 = [  # weak aug
    dict(type='RandomScaling', sigma=1.5, p=0.8),
    dict(type='RandomPermutation', max_segments=12, p=0.8),
    dict(type='RandomJitter', sigma=2, p=0.8),
    dict(type='ToTensor'),
]
train_pipeline_2 = [  # strong aug
    dict(type='RandomScaling', sigma=1.5, p=1.0),
    dict(type='RandomPermutation', max_segments=12, p=1.0),
