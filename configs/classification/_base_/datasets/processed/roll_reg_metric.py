...
custom_hooks = [
    dict(type='SAVEHook',
        save_interval=(478 // 128) * 40,  # plot every 20ep
        iter_per_epoch=(478 // 128)),
    dict(type='SSLMetricHook',
        val_dataset=data['val'],
        train_dataset=data['train'],  # remove it if metric_mode is None
        forward_mode='vis',
        # metric_mode=['knn', 'svm',],
        metric_mode=None,
        metric_args=dict(
        ...
        visual_mode=None,
        visual_args=dict(n_epochs=300, plot_backend='matplotlib'),
