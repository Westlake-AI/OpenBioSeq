...
class Downsampling(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, padding=0,
        ...
        self.conv = ConvModule(in_channels, out_channels, kernel_size=kernel_size,
                               stride=stride, padding=padding, conv_cfg=conv_cfg)
...
class SepConv(nn.Module):
    ...
    """
    def __init__(self, dim, expansion_ratio=2, conv_cfg=dict(type='Conv2d'),
        ...
        self.dwconv = ConvModule(  # depthwise conv
...
class MetaFormerBlock(nn.Module):
    ...
    def __init__(self, dim,
        ...
        self.token_mixer = token_mixer(dim=dim, drop=drop, conv_cfg=conv_cfg)
