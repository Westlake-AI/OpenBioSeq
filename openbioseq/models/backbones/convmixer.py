...
class ConvMixer(BaseBackbone):
    ...
    def __init__(self,
        ...
        self.stem = ConvModule(
            ...
            stride=self.patch_size if patchfied else min(4, self.patch_size // 2),
                ...
                Residual(
                    nn.Sequential(
                        ConvModule(
                            ...
                            groups=self.embed_dims // num_heads,
                            stride=1,
                            padding=self.kernel_size // 2,
                            padding_mode='zeros',
                            conv_cfg=conv_cfg), self.act,
        ...
        for m in self.modules():
            for m in self.modules():
                if isinstance(m, (nn.Conv1d, nn.Conv2d, nn.Linear)):
                    ...
                    _BatchNorm, nn.LayerNorm, nn.GroupNorm)):
